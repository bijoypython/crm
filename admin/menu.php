          ...
          <?php if ($_SESSION['role'] == "super") { ?>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item dropdown ">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo $base_url ?>/bijoy/admin_report.php" class="nav-link ">
                      <i class="fa fa-calculator nav-icon"></i>
                      <p>Admin Target</p>
                    </a>
                  </li>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo $base_url ?>/bijoy/admin_defaulter.php" class="nav-link ">
                      <i class="fa fa-calculator nav-icon"></i>
                      <p>Admin Target Defaulter</p>
                    </a>
                  </li>
                </ul>
              </li>
