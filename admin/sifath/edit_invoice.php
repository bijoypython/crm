            ...
            <div class="col-lg-12">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  <form action="update_invoice.php?invoice_id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                            ...
                            <tbody id="pd">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <input type="text" id="m_<?php echo $i ?>" name="price[]" readonly value="<?php echo $data['price'] ?>">
                                    <input type="hidden" id="pk_<?php echo $i ?>" name="pid[]" readonly value="<?php echo $data['product_id'] ?>">
                                  </td>

                                  <td>
                                    <input type="text" name="qID[]" id="q_<?php echo $i ?>" onkeyup="payable(<?php echo $i ?>)" value="<?php echo $data['quantity'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" id="t_<?php echo $i ?>" name="tot" readonly value="<?php echo $data['total'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" name="vat[]" id="tx_<?php echo $i ?>" value="<?php echo $data['vat'] ?>" onkeyup="payable(<?php echo $i ?>)">
                                  </td>
                                  <td><input type="text" id="p_<?php echo $i ?>" name="stotal[]" class="total" readonly value="<?php echo $data['payable'] ?>"></td>
                                </tr>
                              <?php } ?>
                            </tbody>
                            <tr>
