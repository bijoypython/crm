              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">                    
                  <div class="form-group">
                    <label for="exampleInputEmail1">Select An Admin</label>
                    <select name="" id="admin_s" class="form-control">
                      <option value=""><strong> Select An Admin </strong></option>
                      <?php while($dt=$result->fetch_assoc()){ ?>
